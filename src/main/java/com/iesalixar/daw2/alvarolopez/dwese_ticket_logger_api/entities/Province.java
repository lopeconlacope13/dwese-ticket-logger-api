...
@Table(name = "provinces") // Define el nombre de la tabla asociada a estaentidad.
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Province {
    ...
    private long id;
    // Campo que almacena el código de la provincia, normalmente una cadena cortaque identifica la provincia.
...
// Campo que almacena el nombre completo de la provincia, como "Sevilla" o"Jaén".
    ...
    // Relación con la entidad `Region`, representando la comunidad autónoma ala que pertenece la provincia.
